use inkwell::{context::Context, types::{AnyType, AnyTypeEnum, BasicType, BasicTypeEnum, FunctionType}};
...
pub fn parse_method_type<T: ToString>(ctx: &Context, d: T) -> (usize, FunctionType) {
